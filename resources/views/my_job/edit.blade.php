        ...
        <form action="{{ route('my-jobs.update', $job) }}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :value="$job->experience" :options="array_combine(
                        array_map('ucfirst', \App\Models\Joob::$experience),
                        \App\Models\Joob::$experience,
                    )" :allOption='false' />
                </div>
                <div>
                    <x-label for="categories" :required="true">Category</x-label>
                    <x-radio-group name="categories" :value="$job->category" :options="\App\Models\Joob::$category" :all-option='false' />
                </div>
            </div>
            <div class="col-span-2">
